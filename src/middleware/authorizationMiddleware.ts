...
export const requirePatientRead = requirePermission(
  ResourceType.PATIENT,
  Action.READ
);
export const requirePatientWrite = requirePermission(
  ResourceType.PATIENT,
  Action.WRITE
);
export const requirePatientCreate = requirePermission(
  ResourceType.PATIENT,
  Action.CREATE
);
export const requirePatientDelete = requirePermission(
  ResourceType.PATIENT,
  Action.DELETE
);

export const requireVisitRead = requirePermission(
  ResourceType.VISIT,
  Action.READ
);
export const requireVisitWrite = requirePermission(
  ResourceType.VISIT,
  Action.WRITE
);
export const requireVisitCreate = requirePermission(
  ResourceType.VISIT,
  Action.CREATE
);
export const requireVisitDelete = requirePermission(
  ResourceType.VISIT,
  Action.DELETE
);

export const requireAppointmentRead = requirePermission(
  ResourceType.APPOINTMENT,
  Action.READ
);
export const requireAppointmentWrite = requirePermission(
  ResourceType.APPOINTMENT,
  Action.WRITE
);
export const requireAppointmentCreate = requirePermission(
  ResourceType.APPOINTMENT,
  Action.CREATE
);
export const requireAppointmentDelete = requirePermission(
  ResourceType.APPOINTMENT,
  Action.DELETE
);

export const requireMedicalProviderRead = requirePermission(
  ResourceType.MEDICAL_PROVIDER,
  Action.READ
);
export const requireMedicalProviderWrite = requirePermission(
  ResourceType.MEDICAL_PROVIDER,
  Action.WRITE
);
export const requireMedicalProviderCreate = requirePermission(
  ResourceType.MEDICAL_PROVIDER,
  Action.CREATE
);
export const requireMedicalProviderDelete = requirePermission(
  ResourceType.MEDICAL_PROVIDER,
  Action.DELETE
);

export const requireBillingRead = requirePermission(
  ResourceType.BILLING,
  Action.READ
);
export const requireBillingWrite = requirePermission(
  ResourceType.BILLING,
  Action.WRITE
);
export const requireBillingCreate = requirePermission(
  ResourceType.BILLING,
  Action.CREATE
);
export const requireBillingDelete = requirePermission(
  ResourceType.BILLING,
  Action.DELETE
);

export const requireClinicalNotesRead = requirePermission(
  ResourceType.CLINICAL_NOTES,
  Action.READ
);
export const requireClinicalNotesWrite = requirePermission(
  ResourceType.CLINICAL_NOTES,
  Action.WRITE
);
export const requireClinicalNotesCreate = requirePermission(
  ResourceType.CLINICAL_NOTES,
  Action.CREATE
);
export const requireClinicalNotesDelete = requirePermission(
  ResourceType.CLINICAL_NOTES,
  Action.DELETE
);
